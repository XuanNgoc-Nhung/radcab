<section
    ...
    <div
        class="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(93,0,255,0.25),transparent_60%),radial-gradient(circle_at_80%_70%,rgba(0,204,255,0.25),transparent_60%)] animate-pulse-slow">
    </div>
...
<section class="py-16 px-6 lg:px-16">
    ...
    <div id="press_R" class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8"><a target="_blank"
            ...
            <div class="w-full lg:h-48 mb-4 overflow-hidden rounded-lg"><img
                    alt="Ripple $RLUSD &amp;#8211; Redefining Global Payments with 24/7 Crypto Access" loading="lazy"
                    width="400" height="200" decoding="async" data-nimg="1"
                    class="object-cover w-full h-full transition-transform duration-300 group-hover:scale-105"
                    style="color:transparent"
            ...
            <div class="w-full lg:h-48 mb-4 overflow-hidden rounded-lg"><img
                    alt="Revolutionising Industry Supply Chain with Custom Smart Contract" loading="lazy" width="400"
                    height="200" decoding="async" data-nimg="1"
                    class="object-cover w-full h-full transition-transform duration-300 group-hover:scale-105"
                    style="color:transparent"
    ...
    <div class="relative overflow-hidden" style="background-color:#2C64FA">
        <div class="max-w-full-- mx-auto px-4 md:px-0 flex flex-col md:flex-row items-start relative z-10 max-w-7xl">
            <div class="w-full md:w-1/2 pt-12 pb-12 lg:py-14 px-4">
                <h2 class="text-lg md:text-4xl font-unbounded font-semibold lg:leading-snug mb-2 text-white">Get
                    insights on company achievements and milestones</h2>
                <p class="font-medium text-lg mb-6 text-white">Join our network to receive the latest updates, press
                    releases, and exclusive insights on blockchain innovation. Whether you’re a journalist, partner, or
                    enthusiast, we provide all the information you need to stay ahead in the Web3 and blockchain
                    ecosystem</p><a class="link_button" href="/contact">Contact Our Media Team</a>
            </div>
        </div>
        <div class="hidden md:block absolute right-0 bottom-0 w-[40%] h-full"><img alt="Office Banner" loading="lazy"
                decoding="async" data-nimg="fill" class="object-cover object-bottom-right"
...
<section class="w-full lg:py-16 py-16 px-4">
    <div class="max-w-7xl mx-auto">
        <h2 class="text-center gradient-text font-medium text-xl sm:text-4xl lg:mb-12 mb-6">Frequently Asked Questions
        </h2>
        <div class="grid lg:gap-6 gap-4 grid-cols-1 lg:grid-cols-2">
            <div class="lg:space-y-6 space-y-2">
                    ...
                    <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                        ...
                        <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                            <div
                                ...
                                All press releases are available on our Press &amp; Media page. You can view, read, and
                                share the latest updates directly from our website.</div>
                        </div>
                    </div>
                </div>
                <div class="" style="animation-delay:100ms">
                    <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                        ...
                        <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                            <div
                                class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                Yes, media and press assets are available for download in our Media Kit. Please ensure
                                proper attribution when using our logos or content.</div>
                        </div>
                    </div>
                </div>
                <div class="" style="animation-delay:200ms">
                    <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            class="accordion-trigger">
                            <h3 class="font-normal text-base md:font-medium md:text-base">Who should I contact for press
                                inquiries?</h3>
                            <div
                                class="flex-shrink-0 w-9 h-9 bg-card card-shadow dark:shadow-none flex items-center justify-center rounded-md">
                                <div
                        ...
                        <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                            <div
                                class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                For interviews, collaborations, or press inquiries, contact us at info@nadcab.com, and
                                our media team will assist you promptly.</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="lg:space-y-6 space-y-2">
                <div class="" style="animation-delay:0ms">
                    <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            class="accordion-trigger">
                            <h3 class="font-normal text-base md:font-medium md:text-base">How often are press releases
                                updated?</h3>
                            <div
                                class="flex-shrink-0 w-9 h-9 bg-card card-shadow dark:shadow-none flex items-center justify-center rounded-md">
                                <div
                        ...
                        <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                            <div
                                class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                We regularly publish press releases and announcements related to company milestones,
                                partnerships, product launches, and industry insights.</div>
                        </div>
                    </div>
                </div>
                <div class="" style="animation-delay:100ms">
                    <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            class="accordion-trigger">
                            <h3 class="font-normal text-base md:font-medium md:text-base">Can I subscribe to receive
                                press updates?</h3>
                            <div
                                class="flex-shrink-0 w-9 h-9 bg-card card-shadow dark:shadow-none flex items-center justify-center rounded-md">
                                <div
