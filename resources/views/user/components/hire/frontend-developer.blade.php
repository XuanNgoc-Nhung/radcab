    <div class="relative w-full bg-black overflow-hidden mb-10 pt-16 lg:pt-10">
        <div class="flex flex-col md:flex-row items-center justify-between min-h-[70vh]">
            <div class="max-w-2xl mx-auto md:w-1/2 w-full text-center md:text-left px-6 md:px-12 py-12 md:py-0">
                <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-5">Hire Experienced Frontend Developers
                </h1>
                <p class="text-base md:text-lg text-gray-300 mb-8 leading-relaxed">
                    <div>
                        <p><span style="font-weight: 400;">Your product deserves an interface that feels smooth, fast,
                                and intuitive, whether you’re serving 10 users or 10 million.</span></p>
                    </div>
            ...
            <div class="relative w-full md:w-1/2 h-[250px] md:h-[70vh]"><img alt="Hire section"
                    ...
                    src="/wp-content/uploads/2025/11/xizwtpiwqewW9qZVGgeXy5Ee0kOc8MAHrkFwEXtm.avif">
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-16">
            <div class="flex-1 w-full text-center sm:text-left">
                <div class="grid grid-cols-2 gap-x-8 gap-y-10">
                    ...
                    <div class="">
                        <div class="font-medium text-3xl sm:text-5xl lg:text-7xl">2600+</div>
                    ...
                    <div class="col-span-full lg:mt-6 sm:mt-8 flex justify-center sm:justify-start"><a
                            class="link_button_dark" href="#hire-developer-form">Hire Frontend Developers</a></div>
                </div>
            </div>
            <div class="flex-1 w-full">
                <div class="relative w-full h-56 sm:h-80 md:h-96 lg:h-[400px] overflow-hidden rounded-md"><img
                        ...
                        sizes="100vw"
                        srcset="/wp-content/uploads/2025/11/ui-uxflow-scaled.webp 640w, /wp-content/uploads/2025/11/ui-uxflow-scaled.webp 750w, /wp-content/uploads/2025/11/ui-uxflow-scaled.webp 828w, /wp-content/uploads/2025/11/ui-uxflow-scaled.webp 1080w, /wp-content/uploads/2025/11/ui-uxflow-scaled.webp 1200w, /wp-content/uploads/2025/11/ui-uxflow-scaled.webp 1920w, /wp-content/uploads/2025/11/ui-uxflow-scaled.webp 2048w, /wp-content/uploads/2025/11/ui-uxflow-scaled.webp 3840w"
                        src="/wp-content/uploads/2025/11/ui-uxflow-scaled.webp"
    ...
    <section class="md:my-16 px-4 md:px-0 max-w-7xl mx-auto">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-3xl md:text-5xl font-unbounded text-center mb-12 lg:leading-snug">Hire Dedicated Frontend
                Developers to Power Your Product with Precision &amp; Performance</h2>
        </div>
        <div class="flex flex-col md:flex-row gap-8 lg:gap-12">
            <div class="w-full md:w-8/12 lg:w-7/12">
                <div
                    ...
                    <p data-start="0" data-end="196">Your frontend is the first impression of your application and
                        defines how users interact with your product. It shapes engagement usability and overall
                        experience across web and mobile platforms.</p>
                </div>
                <div
                    class="text-sm md:text-lg text-muted-foreground mb-4 prose prose-lg max-w-none  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                    <p>Our engineers craft responsive dynamic and intuitive interfaces optimized for every device. They
                        ensure seamless navigation pixel perfect design and high performance to create engaging user
                        experiences that drive lasting impact.</p>
                </div>
            </div>
            <div class="w-full md:w-4/12 lg:w-5/12">
                <ul class="space-y-4 md:space-y-3">
                    <li class="flex items-start gap-3"><span
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Interactive UI/UX
                    ...
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></span><span class="text-sm md:text-base text-muted-foreground leading-relaxed">Speed,
                            performance &amp; SEO-ready structure</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Real-time data rendering
                            &amp; state management</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            integration, error handling &amp; optimization</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Cross-platform
                            responsiveness &amp; accessibility</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Component-driven
                            architecture (React, Vue, Angular)</span></li>
                </ul>
            </div>
        </div>
    </section>
    <section class="py-16 lg:py-16 overflow-hidden px-6 lg:px-0">
        <div class="max-w-7xl mx-auto">
            <div class="max-w-6xl mx-auto px-6 text-center">
                <h2 class="text-3xl md:text-5xl font-unbounded mb-2 md:leading-snug">Why Teams Trust Our Frontend
                    Developers</h2>
                <div
                    class="max-w-4xl mx-auto mb-12 text-lg text-muted-foreground  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                    <p>Our frontend experts blend design and engineering to build fast intuitive interfaces that deliver
                        seamless performance and exceptional user experiences.</p>
                </div>
            </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <img alt="Get In Touch" loading="lazy" width="60" height="60" decoding="async" data-nimg="1"
                            ...
                            srcset="/wp-content/uploads/2025/09/Get-In-Touch.webp 1x, /wp-content/uploads/2025/09/Get-In-Touch.webp 2x"
                    ...
                    <div
                        ...
                        <p>Tell us your design goals, user flow, and preferred tech stack like React, Vue, or Angular
                            for tailored frontend solutions.</p>
                    </div>
                </div>
                <div
                    class="rounded-xl bg-card text-card-foreground card-shadow p-6 text-center flex flex-col items-center">
                    <div
                        ...
                        <img alt="Team Allocation" loading="lazy" width="60" height="60" decoding="async" data-nimg="1"
                            class="object-contain"
                            srcset="/wp-content/uploads/2025/09/Team-Allocation.webp 1x, /wp-content/uploads/2025/09/Team-Allocation.webp 2x"
                            src="/wp-content/uploads/2025/09/Team-Allocation.webp"
                            style="color: transparent;"></div>
                    <h3 class="text-xl font-medium mb-3">Team Allocation</h3>
                    <div
                        class="text-sm text-muted-foreground leading-relaxed  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p>We match you with expert frontend developers experienced in SaaS, fintech, eCommerce, gaming,
                            and enterprise-grade platforms.</p>
                    </div>
                </div>
                <div
                    class="rounded-xl bg-card text-card-foreground card-shadow p-6 text-center flex flex-col items-center">
                    <div
                        ...
                        <img alt="Schedule an Interview" loading="lazy" width="60" height="60" decoding="async"
                            ...
                            srcset="/wp-content/uploads/2025/09/Schedule-an-Interview.webp 1x, /wp-content/uploads/2025/09/Schedule-an-Interview.webp 2x"
                            src="/wp-content/uploads/2025/09/Schedule-an-Interview.webp"
                            style="color: transparent;"></div>
                    <h3 class="text-xl font-medium mb-3">Schedule an Interview</h3>
                    <div
                        class="text-sm text-muted-foreground leading-relaxed  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p>Meet skilled developers with proven UX expertise, clean code practices, and scalable frontend
                            architecture for long-term success.</p>
                    </div>
                </div>
                <div
                    class="rounded-xl bg-card text-card-foreground card-shadow p-6 text-center flex flex-col items-center">
                    <div
                        ...
                        <img alt="Team Onboarding" loading="lazy" width="60" height="60" decoding="async" data-nimg="1"
                            class="object-contain"
                            srcset="/wp-content/uploads/2025/09/Team-Onboarding.webp 1x, /wp-content/uploads/2025/09/Team-Onboarding.webp 2x"
                            src="/wp-content/uploads/2025/09/Team-Onboarding.webp"
                            style="color: transparent;"></div>
                    <h3 class="text-xl font-medium mb-3"> Team Onboarding</h3>
                    <div
                        class="text-sm text-muted-foreground leading-relaxed  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p>After selection, we handle setup, tools, and workflows ensuring smooth collaboration across
                            your time zone and communication style.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-6 lg:px-0">
            <h2
                ...
                Frontend Engineering for Products That Engage Not Just Exist</h2>
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img alt="Responsive Theme Design" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="/wp-content/uploads/2025/10/Responsive-Theme-Design.webp 1x, /wp-content/uploads/2025/10/Responsive-Theme-Design.webp 2x"
                                src="/wp-content/uploads/2025/10/Responsive-Theme-Design.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Responsive UI Architecture</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We build interfaces that adapt perfectly across devices and
                                browsers, maintaining visual harmony and performance consistency.</span></p>
                    </div>
                </div>
                <div
                    class="text-card-foreground card-shadow flex flex-col items-center text-center bg-card rounded-xl card-shadow p-4 sm:p-6 h-full hover:shadow-lg transition-shadow duration-300">
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="Real-Time Data Tracking" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="/wp-content/uploads/2025/09/Real-Time-Data-Tracking.webp 1x, /wp-content/uploads/2025/09/Real-Time-Data-Tracking.webp 2x"
                                src="/wp-content/uploads/2025/09/Real-Time-Data-Tracking.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Interactive &amp; Real-Time Experience
                    </h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">From live dashboards to collaborative tools, our engineers
                                implement event-driven UIs with frameworks like React, Vue, and WebSockets.</span></p>
                    </div>
                </div>
                <div
                    class="text-card-foreground card-shadow flex flex-col items-center text-center bg-card rounded-xl card-shadow p-4 sm:p-6 h-full hover:shadow-lg transition-shadow duration-300">
                    <div
                        ...
                        <div
                            ...
                            <img alt="Custom Theme Design" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="/wp-content/uploads/2025/10/Custom-Theme-Design.webp 1x, /wp-content/uploads/2025/10/Custom-Theme-Design.webp 2x"
                                src="/wp-content/uploads/2025/10/Custom-Theme-Design.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Design System &amp; Component Libraries
                    </h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We craft reusable components and scalable design systems,
                                ensuring visual consistency and faster feature development.</span></p>
                    </div>
                </div>
                <div
                    class="text-card-foreground card-shadow flex flex-col items-center text-center bg-card rounded-xl card-shadow p-4 sm:p-6 h-full hover:shadow-lg transition-shadow duration-300">
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="Greater Accessibility" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="/wp-content/uploads/2025/08/Greater-Accessibility.webp 1x, /wp-content/uploads/2025/08/Greater-Accessibility.webp 2x"
                                src="/wp-content/uploads/2025/08/Greater-Accessibility.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Accessibility &amp; User-Centered Design
                    </h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Our developers follow WCAG and usability guidelines so every
                                user enjoys an inclusive, intuitive experience.</span></p>
                    </div>
                </div>
                <div
                    class="text-card-foreground card-shadow flex flex-col items-center text-center bg-card rounded-xl card-shadow p-4 sm:p-6 h-full hover:shadow-lg transition-shadow duration-300">
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="Smooth API Integration" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="/wp-content/uploads/2025/10/Smooth-API-Integration.webp 1x, /wp-content/uploads/2025/10/Smooth-API-Integration.webp 2x"
                                src="/wp-content/uploads/2025/10/Smooth-API-Integration.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">API Integration &amp; State Management
                    </h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We implement secure API calls, global state management
                                (Redux, Vuex, Zustand), and data synchronization that never breaks under stress.</span>
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="SEO &amp; Search Visibility" loading="lazy" width="40" height="40"
                                decoding="async" data-nimg="1" class="object-contain dark:invert"
                                srcset="/wp-content/uploads/2025/10/SEO-Search-Visibility.webp 1x, /wp-content/uploads/2025/10/SEO-Search-Visibility.webp 2x"
                                src="/wp-content/uploads/2025/10/SEO-Search-Visibility.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Frontend &amp; SEO Optimization</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We focus on Core Web Vitals, lazy loading, caching, and
                                minification ensuring your app loads fast and ranks higher.</span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row sm:flex-row">
                <div class="w-full lg:w-7/12 flex items-center dark:bg-white dark:text-black dark:shadow-none">
                    <div class="p-6 lg:p-8 space-y-3">
                        ...
                        <h4 class="font-medium text-xl sm:text-xl md:text-3xl">High-Performance Frontends Require
                            Experienced Hands</h4>
                        <p class="text-base sm:text-sm [&amp;_a]:text-blue-600 ">Work with experts in design,
                            performance, and scalability.</p>
                        <div class="pt-2"><a class="link_button_blue" href="#hire-developer-form">Talk to Frontend
                ...
                <div class="relative w-full lg:w-5/12 h-72"><img alt="Feature Image" loading="lazy" decoding="async"
                        ...
                        srcset="/wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 640w, /wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 750w, /wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 828w, /wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 1080w, /wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 1200w, /wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 1920w, /wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 2048w, /wp-content/uploads/2025/11/Expert-Frontend-Developers.webp 3840w"
                        src="/wp-content/uploads/2025/11/Expert-Frontend-Developers.webp"
                        style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-10">
                <h2
                    ...
                    Technologies, Frameworks &amp; Tools We Build Frontend Systems On</h2>
                <p class="max-w-4xl mx-auto font-normal text-muted-foreground text-sm sm:text-base text-center ">We
                    apply the right stack for each project’s visual, performance, and scalability needs. Ensuring your
                    frontend is fast, reliable, and production-ready.</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div
                                ...
                                <img alt="Next.js" loading="lazy" width="30" height="30" decoding="async" data-nimg="1"
                                    class="flex-shrink-0 "
                                    srcset="/wp-content/uploads/2025/11/Next.js-removebg-preview.webp 1x, /wp-content/uploads/2025/11/Next.js-removebg-preview.webp 2x"
                            ...
                            <div
                                ...
                                <img alt="Angular JS" loading="lazy" width="30" height="30" decoding="async"
                                    ...
                                    srcset="/wp-content/uploads/2025/11/angularjs1.webp 1x, /wp-content/uploads/2025/11/angularjs1.webp 2x"
                            ...
                            <div
                                class="bg-card text-card-foreground card-shadow h-16 sm:h-14 lg:h-20 rounded-lg flex items-center gap-3 sm:gap-1 px-4 sm:px-6 dark:bg-gray-400/10 dark:text-black dark:shadow-none">
                                <img alt="Nuxt" loading="lazy" width="30" height="30" decoding="async" data-nimg="1"
                                    class="flex-shrink-0 "
                                    srcset="/wp-content/uploads/2025/11/Nuxt.webp 1x, /wp-content/uploads/2025/11/Nuxt.webp 2x"
                                    src="/wp-content/uploads/2025/11/Nuxt.webp"
                                    style="color: transparent;"><span
                                    class="font-medium text-sm sm:text-sm lg:text-lg line-clamp-2">Nuxt</span></div>
                            <div
                                class="bg-card text-card-foreground card-shadow h-16 sm:h-14 lg:h-20 rounded-lg flex items-center gap-3 sm:gap-1 px-4 sm:px-6 dark:bg-gray-400/10 dark:text-black dark:shadow-none">
                                <img alt="Svelte" loading="lazy" width="30" height="30" decoding="async" data-nimg="1"
                                    class="flex-shrink-0 "
                                    srcset="/wp-content/uploads/2025/11/Svelte.webp 1x, /wp-content/uploads/2025/11/Svelte.webp 2x"
                                    src="/wp-content/uploads/2025/11/Svelte.webp"
                                    style="color: transparent;"><span
                                    class="font-medium text-sm sm:text-sm lg:text-lg line-clamp-2">Svelte</span></div>
                            <div
                                class="bg-card text-card-foreground card-shadow h-16 sm:h-14 lg:h-20 rounded-lg flex items-center gap-3 sm:gap-1 px-4 sm:px-6 dark:bg-gray-400/10 dark:text-black dark:shadow-none">
                                <img alt="Ember" loading="lazy" width="30" height="30" decoding="async" data-nimg="1"
                                    class="flex-shrink-0 "
                                    srcset="/wp-content/uploads/2025/11/Ember-1.webp 1x, /wp-content/uploads/2025/11/Ember-1.webp 2x"
    ...
    <section class="relative bg-black text-white py-16 px-6 lg:px-32 lg:py-24 lg:mb-24">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-base mb-12  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                <p><span style="font-weight: 400;">We don’t outsource. We assign in-house frontend specialists with
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="relative rounded-2xl p-8 border border-gray-700 bg-white text-black">
                    ...
                    <p class="text-sm mb-4  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Hire Frontend Developers monthly to build a long-term
                                partnership focused on growth and design excellence.</span></p>
                    </p>
                ...
                <div class="relative rounded-2xl p-8 border border-blue-500 bg-gradient-to-b from-gray-900 to-black">
                    ...
                    <p class="text-sm mb-4  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Choose our quarterly plan for consistent design optimization
                                and scalable frontend support.</span></p>
                    </p>
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <div class="relative rounded-2xl p-8 border border-gray-700 bg-white text-black">
                    ...
                    <p class="text-sm mb-4  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Opt for our yearly plan to hire expert Frontend Developers
                                for cost-effective, long-term collaboration.</span></p>
                    </p>
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <div class="flex flex-col lg:flex-row">
                <div class="lg:w-1/2 flex flex-col justify-center space-y-4 px-6 sm:px-8 lg:px-10 py-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2  gap-y-4">
                        ...
                        href="https://www.nadcab.com/hire-frontend-developers">Consult Our Experts</a>
                </div>
                <div class="lg:w-1/2 relative"><img alt="hire front end developer" loading="lazy" decoding="async"
                        data-nimg="fill" class="object-cover" sizes="(max-width: 1024px) 100vw, 50vw"
                        srcset="/wp-content/uploads/2025/11/front-end-developer.webp 384w, /wp-content/uploads/2025/11/front-end-developer.webp 640w, /wp-content/uploads/2025/11/front-end-developer.webp 750w, /wp-content/uploads/2025/11/front-end-developer.webp 828w, /wp-content/uploads/2025/11/front-end-developer.webp 1080w, /wp-content/uploads/2025/11/front-end-developer.webp 1200w, /wp-content/uploads/2025/11/front-end-developer.webp 1920w, /wp-content/uploads/2025/11/front-end-developer.webp 2048w, /wp-content/uploads/2025/11/front-end-developer.webp 3840w"
                        src="/wp-content/uploads/2025/11/front-end-developer.webp"
                        style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            </div>
        </div>
    </section>
    <div id="hire-developer-form" class="bg-black text-white py-16 px-6 lg:px-16 lg:mt-16">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div class="lg:col-span-5">
                <h1 class="text-3xl sm:text-5xl md:text-6xl font-semibold mb-6">Ready to Build a Fast, Interactive
                    Frontend?</h1>
                <div
                    ...
                    <p><span style="font-weight: 400;">We work closely with startups, enterprises, and global teams to
                            deliver lightning-fast, visually stunning interfaces that users love.</span></p>
                </div>
