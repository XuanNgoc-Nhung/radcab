    <div class="relative w-full bg-black overflow-hidden mb-10 pt-16 lg:pt-10">
        <div class="flex flex-col md:flex-row items-center justify-between min-h-[70vh]">
            <div class="max-w-2xl mx-auto md:w-1/2 w-full text-center md:text-left px-6 md:px-12 py-12 md:py-0">
                <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-5">Hire Machine Learning Developers</h1>
                <p class="text-base md:text-lg text-gray-300 mb-8 leading-relaxed">
                    <div>
                        <p><span style="font-weight: 400;">Experienced ML engineers delivering intelligent, data-driven
                                systems with automation, accuracy, and scalability for AI-powered business
                                growth.</span></p>
                    </div>
            ...
            <div class="relative w-full md:w-1/2 h-[250px] md:h-[70vh]"><img alt="Hire section"
                    ...
                    src="/wp-content/uploads/2025/11/Machine-Learning-Transparent.webp"></div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-16">
            <div class="flex-1 w-full text-center sm:text-left">
                <div class="grid grid-cols-2 gap-x-8 gap-y-10">
                    ...
                    <div class="">
                        <div class="font-medium text-3xl sm:text-5xl lg:text-7xl">500+</div>
                    ...
                    <div class="col-span-full lg:mt-6 sm:mt-8 flex justify-center sm:justify-start"><a
                            class="link_button_dark" href="#hire-developer-form">Hire Machine Learning Developers</a>
                    </div>
                </div>
            </div>
            <div class="flex-1 w-full">
                <div class="relative w-full h-56 sm:h-80 md:h-96 lg:h-[400px] overflow-hidden rounded-md"><img
                        ...
                        sizes="100vw"
                        srcset="https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=640&amp;q=75 640w, https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=750&amp;q=75 750w, https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=828&amp;q=75 828w, https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=1080&amp;q=75 1080w, https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=1200&amp;q=75 1200w, https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=1920&amp;q=75 1920w, https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=2048&amp;q=75 2048w, https://img.nadcab.com/wp-content/uploads/2025/11/deep-neural-network.webp?w=3840&amp;q=75 3840w"
                        src="/wp-content/uploads/2025/11/deep-neural-network.webp"
    ...
    <section class="md:my-16 px-4 md:px-0 max-w-7xl mx-auto">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-3xl md:text-5xl font-unbounded text-center mb-12 lg:leading-snug">Hire Dedicated Machine
                Learning Engineers to Build Intelligent Solutions</h2>
        </div>
        <div class="flex flex-col md:flex-row gap-8 lg:gap-12">
            <div class="w-full md:w-8/12 lg:w-7/12">
                ...
                <div
                    class="text-sm md:text-lg text-muted-foreground mb-4 prose prose-lg max-w-none  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                    <p>Our team excels in supervised and unsupervised learning, deep learning, predictive modeling, and
                        NLP, designing, training, and deploying scalable ML models for fintech, healthcare, eCommerce,
            ...
            <div class="w-full md:w-4/12 lg:w-5/12">
                <ul class="space-y-4 md:space-y-3">
                    <li class="flex items-start gap-3"><span
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">End-to-end ML model
                            design, training &amp; deployment</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Expertise in TensorFlow,
                            PyTorch, Scikit-learn &amp; Keras</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Flexible hiring: hourly,
                            monthly, or dedicated full-time</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Engineers with 5+ years
                            of verified AI/ML experience</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Integration with APIs,
                            data pipelines &amp; cloud services</span></li>
                    <li class="flex items-start gap-3"><span
                            class="w-6 h-6 bg-card card-shadow rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            class="text-sm md:text-base text-muted-foreground leading-relaxed">Solutions optimized for
                            accuracy, performance &amp; scalability</span></li>
                </ul>
            </div>
        </div>
    </section>
    <section class="py-16 lg:py-16 overflow-hidden px-6 lg:px-0">
        <div class="max-w-7xl mx-auto">
            <div class="max-w-6xl mx-auto px-6 text-center">
                <h2 class="text-3xl md:text-5xl font-unbounded mb-2 md:leading-snug">Streamlined Hiring Process for ML
                    Engineers</h2>
                <div
                    class="max-w-4xl mx-auto mb-12 text-lg text-muted-foreground  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                    <p><span style="font-weight: 400;">Hiring the right ML engineer shouldn’t be complex. Our
                            transparent process connects you with AI professionals who understand scalable data systems,
                            model optimization, and real-world deployment.</span></p>
                </div>
            </div>
            <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div
                    ...
                    <div
                        ...
                        <img alt="Get In Touch" loading="lazy" width="60" height="60" decoding="async" data-nimg="1"
                            ...
                            style="color: transparent;"></div>
                    <h3 class="text-xl font-medium mb-3">Share Your Project Goals</h3>
                    <div
                        class="text-sm text-muted-foreground leading-relaxed  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Tell us about your data, objectives, and the type of ML model
                                you need for a recommendation engine, chatbot, fraud detection, image analysis, or
                ...
                <div
                    ...
                    <div
                        class="text-sm text-muted-foreground leading-relaxed  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We match you with ML specialists who align with your domain,
                                such as fintech, eCommerce, healthcare, or SaaS, ensuring domain expertise and project
                                relevance.</span></p>
                    </div>
                </div>
                <div
                    ...
                    <div
                        class="text-sm text-muted-foreground leading-relaxed  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Evaluate shortlisted engineers through technical assessments
                                and communication rounds. You stay in control while we handle screening and skill
                                verification.</span></p>
                    </div>
                </div>
                <div
                    ...
                    <div
                        class="text-sm text-muted-foreground leading-relaxed  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Once selected, your ML engineer joins your team with full
                                setup, data access, and sprint alignment for a smooth collaboration and measurable
                                milestones.</span></p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-6 lg:px-0">
            <h2
                ...
                Machine Learning Expertise for Every Business Case</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img alt="Predictive Analytics" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="https://img.nadcab.com/wp-content/uploads/2025/10/Predictive-Analytics-Development.webp?w=48&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/10/Predictive-Analytics-Development.webp?w=96&amp;q=75 2x"
                                src="/wp-content/uploads/2025/10/Predictive-Analytics-Development.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Predictive Analytics</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We create advanced predictive models that forecast demand,
                                trends, and customer behavior with precision. </span><span style="font-weight: 400;">Our
                                solutions help businesses make real-time, data-driven decisions that improve outcomes
                                and reduce risks.</span></p>
                    </div>
                </div>
                <div
                    class="text-card-foreground card-shadow flex flex-col items-center text-center bg-card rounded-xl card-shadow p-4 sm:p-6 h-full hover:shadow-lg transition-shadow duration-300">
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="Natural Language Processing (NLP)" loading="lazy" width="40" height="40"
                                decoding="async" data-nimg="1" class="object-contain dark:invert"
                                srcset="https://img.nadcab.com/wp-content/uploads/2025/10/Natural-Language-Processing-1.webp?w=48&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/10/Natural-Language-Processing-1.webp?w=96&amp;q=75 2x"
                                src="/wp-content/uploads/2025/10/Natural-Language-Processing-1.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Natural Language Processing (NLP)</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We build intelligent NLP systems that understand and respond
                                to human language naturally and accurately. </span><span style="font-weight: 400;">From
                                chatbots to sentiment analysis, we enable smarter customer interactions and automated
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="Computer Vision" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="https://img.nadcab.com/wp-content/uploads/2025/10/Computer-Vision.webp?w=48&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/10/Computer-Vision.webp?w=96&amp;q=75 2x"
                                src="/wp-content/uploads/2025/10/Computer-Vision.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Computer Vision</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Our engineers design computer vision models that analyze
                                images and video data with exceptional accuracy. </span><span
                                style="font-weight: 400;">We empower businesses to implement facial recognition, object
                                detection, and visual quality inspection.</span></p>
                    </div>
                </div>
                <div
                    class="text-card-foreground card-shadow flex flex-col items-center text-center bg-card rounded-xl card-shadow p-4 sm:p-6 h-full hover:shadow-lg transition-shadow duration-300">
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="Recommendation Systems" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="https://img.nadcab.com/wp-content/uploads/2025/11/Recommendation_Systems-removebg-preview.png?w=48&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/11/Recommendation_Systems-removebg-preview.png?w=96&amp;q=75 2x"
                                src="/wp-content/uploads/2025/11/Recommendation_Systems-removebg-preview.png"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Recommendation Systems</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We develop machine learning algorithms that predict user
                                preferences and suggest relevant content. </span><span style="font-weight: 400;">These
                                systems enhance personalization, engagement, and sales through smart, data-based
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img alt="Predictive Analytics" loading="lazy" width="40" height="40" decoding="async"
                                data-nimg="1" class="object-contain dark:invert"
                                srcset="https://img.nadcab.com/wp-content/uploads/2025/10/Predictive-Analytics.webp?w=48&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/10/Predictive-Analytics.webp?w=96&amp;q=75 2x"
                                src="/wp-content/uploads/2025/10/Predictive-Analytics.webp"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Predictive Maintenance</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Our predictive maintenance models help detect early signs of
                                machine failure and operational inefficiencies. </span><span
                                style="font-weight: 400;">They minimize downtime, reduce maintenance costs, and extend
                                equipment lifespan through timely insights.</span></p>
                    </div>
                </div>
                <div
                    class="text-card-foreground card-shadow flex flex-col items-center text-center bg-card rounded-xl card-shadow p-4 sm:p-6 h-full hover:shadow-lg transition-shadow duration-300">
                    <div
                        ...
                        <div
                            class="w-10 sm:w-16 h-10 sm:h-16 bg-card rounded-xl card-shadow dark:shadow-none flex items-center justify-center">
                            <img alt="Fraud Detection Systems Icon" loading="lazy" width="40" height="40"
                                decoding="async" data-nimg="1" class="object-contain dark:invert"
                                srcset="https://img.nadcab.com/wp-content/uploads/2025/08/Fraud-Detection-Systems.png?w=48&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/08/Fraud-Detection-Systems.png?w=96&amp;q=75 2x"
                                src="/wp-content/uploads/2025/08/Fraud-Detection-Systems.png"
                                style="color: transparent;"></div>
                    </div>
                    <h3 class="font-semibold text-base sm:text-lg mb-2 sm:mb-3">Fraud Detection &amp; Risk Analysis</h3>
                    <div
                        class="text-muted-foreground text-xs sm:text-sm text-center leading-5 flex-1  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">We design ML systems that analyze real-time transactions to
                                identify anomalies and prevent fraudulent activity. </span><span
                                style="font-weight: 400;">Our models strengthen business security, reduce financial
                                risks, and ensure data integrity across platforms.</span></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl bg-card text-card-foreground card-shadow max-w-7xl mx-auto overflow-hidden">
            <div class="flex flex-col lg:flex-row sm:flex-row">
                    ...
                    <div class="p-6 lg:p-8 space-y-3">
                        <div class="inline-flex items-center gap-1 font-medium w-fit"><span
                                class="w-6 h-6 flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path d="M7 6h3"></path>
                                </svg></span>Trusted by 2100+ Businesses, Startups, and Innovators</div>
                        <h4 class="font-medium text-xl sm:text-xl md:text-3xl">AI Systems Require Experienced Hands</h4>
                        <p class="text-base sm:text-sm [&amp;_a]:text-blue-600 ">Work with ML specialists who understand
                            model architecture, data pipelines, feature engineering, and production-level deployment.
                        </p>
                        <div class="pt-2"><a class="link_button_blue" href="#hire-developer-form">Talk to an ML
                ...
                <div class="relative w-full lg:w-5/12 h-72"><img alt="Feature Image" loading="lazy" decoding="async"
                        ...
                        srcset="https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=640&amp;q=75 640w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=750&amp;q=75 750w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=828&amp;q=75 828w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=1080&amp;q=75 1080w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=1200&amp;q=75 1200w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=1920&amp;q=75 1920w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=2048&amp;q=75 2048w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp?w=3840&amp;q=75 3840w"
                        src="/wp-content/uploads/2025/11/Machine-Learning-Cover-Image.webp"
                        style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-10">
                <h2
                    ...
                    Technologies, Frameworks &amp; Platforms We Build ML Models On</h2>
                <p class="max-w-4xl mx-auto font-normal text-muted-foreground text-sm sm:text-base text-center ">We
                    apply the right frameworks, cloud tools, and deployment pipelines to match your model’s performance
                    requirements, ensuring your ML systems are accurate, efficient, and production-ready.</p>
            </div>
            <div class="sm:hidden max-w-7xl mx-auto">
                <div class="rounded-xl bg-card text-card-foreground card-shadow mb-4">
                    <div class="flex items-center justify-between p-4 cursor-pointer">
                        <div class="flex gap-3 items-center">
                            <h3 class="text-base font-medium"> Frameworks &amp; Libraries</h3>
                ...
                <div class="rounded-xl bg-card text-card-foreground card-shadow mb-4">
                    <div class="flex items-center justify-between p-4 cursor-pointer">
                        <div class="flex gap-3 items-center">
                            <h3 class="text-base font-medium">Collaboration &amp; Development Workflow</h3>
                        </div><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20"
                            aria-hidden="true" class="transition-transform duration-300 " height="20" width="20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <div class="rounded-xl bg-card text-card-foreground card-shadow mb-4">
                    <div class="flex items-center justify-between p-4 cursor-pointer">
                        <div class="flex gap-3 items-center">
                            <h3 class="text-base font-medium">Deployment &amp; Hosting Platforms</h3>
                        </div><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20"
                            aria-hidden="true" class="transition-transform duration-300 " height="20" width="20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <div class="rounded-xl bg-card text-card-foreground card-shadow mb-4">
                    <div class="flex items-center justify-between p-4 cursor-pointer">
                        <div class="flex gap-3 items-center">
                            <h3 class="text-base font-medium">Version Control &amp; Release Management</h3>
                        </div><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20"
                            aria-hidden="true" class="transition-transform duration-300 " height="20" width="20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                        ...
                        <div class="space-y-4">
                            <div>
                                <div class="clickable-row bg-blue-400">
                                    <h3 class="font-normal text-lg sm:text-xl lg:text-2xl"> Frameworks &amp; Libraries
                                    </h3><span class="ml-auto text-xl sm:text-2xl lg:text-3xl"><svg
                            ...
                            <div>
                                <div class="clickable-row hover:bg-blue-400">
                                    <h3 class="font-normal text-lg sm:text-xl lg:text-2xl">Collaboration &amp;
                            ...
                            <div>
                                <div class="clickable-row hover:bg-blue-400">
                                    <h3 class="font-normal text-lg sm:text-xl lg:text-2xl">Deployment &amp; Hosting
                                        Platforms</h3>
                                </div>
                                <div class="my-4"></div>
                            </div>
                            <div>
                                <div class="clickable-row hover:bg-blue-400">
                                    <h3 class="font-normal text-lg sm:text-xl lg:text-2xl">Version Control &amp; Release
                                        Management</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div
                                ...
                                <img alt="PyTorch" loading="lazy" width="30" height="30" decoding="async" data-nimg="1"
                                    class="flex-shrink-0 "
                                    srcset="https://img.nadcab.com/wp-content/uploads/2025/11/PyTorch.webp?w=32&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/11/PyTorch.webp?w=64&amp;q=75 2x"
                            ...
                            <div
                                class="bg-card text-card-foreground card-shadow h-16 sm:h-14 lg:h-20 rounded-lg flex items-center gap-3 sm:gap-1 px-4 sm:px-6 dark:bg-gray-400/10 dark:text-black dark:shadow-none">
                                <img alt="Scikit-learn" loading="lazy" width="30" height="30" decoding="async"
                                    data-nimg="1" class="flex-shrink-0 "
                                    srcset="https://img.nadcab.com/wp-content/uploads/2025/11/scikit-learn.webp?w=32&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/11/scikit-learn.webp?w=64&amp;q=75 2x"
                                    src="/wp-content/uploads/2025/11/scikit-learn.webp"
                                    style="color: transparent;"><span
                                    class="font-medium text-sm sm:text-sm lg:text-lg line-clamp-2">Scikit-learn</span>
                            </div>
                            <div
                                class="bg-card text-card-foreground card-shadow h-16 sm:h-14 lg:h-20 rounded-lg flex items-center gap-3 sm:gap-1 px-4 sm:px-6 dark:bg-gray-400/10 dark:text-black dark:shadow-none">
                                <img alt="Hugging Face" loading="lazy" width="30" height="30" decoding="async"
                                    data-nimg="1" class="flex-shrink-0 "
                                    srcset="https://img.nadcab.com/wp-content/uploads/2025/11/hugging_face.webp?w=32&amp;q=75 1x, https://img.nadcab.com/wp-content/uploads/2025/11/hugging_face.webp?w=64&amp;q=75 2x"
    ...
    <section class="relative bg-black text-white py-16 px-6 lg:px-32 lg:py-24 lg:mb-24">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-base mb-12  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                <p><span style="font-weight: 400;">We don’t outsource. We assign in-house ML specialists with verifiable
                        experience in AI model development, data engineering, and cloud deployment.</span></p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="relative rounded-2xl p-8 border border-gray-700 bg-white text-black">
                    ...
                    <p class="text-sm mb-4  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Hire ML Developers monthly to ensure continuous AI model
                                optimization and deployment stability.</span></p>
                    </p>
                ...
                <div class="relative rounded-2xl p-8 border border-blue-500 bg-gradient-to-b from-gray-900 to-black">
                    ...
                    <p class="text-sm mb-4  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Choose our quarterly plan for ongoing ML improvements,
                                feature updates, and continuous monitoring.</span></p>
                    </p>
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg>Continuous Model Improvement</li>
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                ...
                <div class="relative rounded-2xl p-8 border border-gray-700 bg-white text-black">
                    ...
                    <p class="text-sm mb-4  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                        <p><span style="font-weight: 400;">Opt for our yearly plan to hire expert ML Engineers for
                                cost-effective, long-term collaboration.</span></p>
                    </p>
                    <ul class="space-y-3 mb-6">
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                ...
                                class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg>End-to-End AI Development</li>
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg>Project Documentation &amp; Maintenance</li>
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg>Continuous Learning &amp; Retraining</li>
                        <li class="flex items-center gap-3 text-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
    ...
    <section class="relative w-full py-16 px-4 lg:p-0">
        <div class="bg-card card-shadow dark:shadow-none rounded-2xl max-w-7xl mx-auto overflow-hidden">
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="lg:w-1/2 relative"><img alt="Nacab Machine LeARNING" loading="lazy" decoding="async"
                        data-nimg="fill" class="object-cover" sizes="(max-width: 1024px) 100vw, 50vw"
                        srcset="https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=384&amp;q=75 384w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=640&amp;q=75 640w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=750&amp;q=75 750w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=828&amp;q=75 828w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=1080&amp;q=75 1080w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=1200&amp;q=75 1200w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=1920&amp;q=75 1920w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=2048&amp;q=75 2048w, https://img.nadcab.com/wp-content/uploads/2025/11/Machine-learning-def-.webp?w=3840&amp;q=75 3840w"
                        src="/wp-content/uploads/2025/11/Machine-learning-def-.webp"
                        style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            </div>
        </div>
    </section>
    <div id="hire-developer-form" class="bg-black text-white py-16 px-6 lg:px-16 lg:mt-16">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div class="lg:col-span-5">
                <h1 class="text-3xl sm:text-5xl md:text-6xl font-semibold mb-6">Ready to Turn Data Into Actionable
                    Intelligence?</h1>
                <div
                    class="text-gray-300 mb-6 prose prose-invert  [&amp;_a]:text-blue-600 dark:[&amp;_a]:text-blue-400">
                    <p><span style="font-weight: 400;">We collaborate with startups and enterprises to bring machine
                            learning ideas to life, from data collection to model deployment.</span></p>
                </div>
                <ul class="space-y-3 text-gray-300">
                    <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                            <path d="M20 6 9 17l-5-5"></path>
                        </svg>2100+ Successful AI Deployments</li>
                    <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                            <path d="M20 6 9 17l-5-5"></path>
                        </svg>1200+ ML Experts Across Cloud Platforms</li>
                    <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                            <path d="M20 6 9 17l-5-5"></path>
                        </svg>97% Client Retention &amp; Ongoing Partnerships</li>
                    <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                    ...
                    <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            class="lucide lucide-check text-blue-400 w-5 h-5" aria-hidden="true">
                            <path d="M20 6 9 17l-5-5"></path>
                        </svg>Expert Support From Strategy → Development → Launch</li>
                </ul>
            </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div class="flex items-center gap-3 bg-gray-50 px-3 py-2 rounded-md border border-gray-200">
                            <span class="font-medium">7</span><span class="font-medium">+</span><span
                                class="font-medium">4</span><span class="font-medium">=</span><input
            ...
            <div class="grid lg:gap-6 gap-4 grid-cols-1 lg:grid-cols-2">
                <div class="lg:space-y-6 space-y-2">
                    <div class="" style="animation-delay: 0ms;">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                                ...
                                <h3 class="font-normal text-base md:font-medium md:text-base">How soon can I onboard an
                                    ML engineer?</h3>
                                <div
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    ...
                                    Once you share your requirements, we can match and onboard the right ML Engineer
                                    within 3–5 business days.</div>
                            </div>
                        </div>
                    </div>
                    <div class="" style="animation-delay: 100ms;">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                                class="accordion-trigger">
                                <h3 class="font-normal text-base md:font-medium md:text-base">Can you integrate ML with
                                    existing systems?</h3>
                                <div
                                    class="flex-shrink-0 w-9 h-9 bg-card card-shadow dark:shadow-none flex items-center justify-center rounded-md">
                                    <div
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    Yes, our engineers seamlessly integrate machine learning models into your existing
                                    apps, APIs, and data pipelines.</div>
                            </div>
                        </div>
                    </div>
                    <div class="" style="animation-delay: 200ms;">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                                class="accordion-trigger">
                                <h3 class="font-normal text-base md:font-medium md:text-base">What does a Machine
                                    Learning Engineer do?</h3>
                                <div
                                    class="flex-shrink-0 w-9 h-9 bg-card card-shadow dark:shadow-none flex items-center justify-center rounded-md">
                                    <div
                                        class="w-7 h-7 flex items-center justify-center bg-card card-shadow dark:shadow-none rounded-md ">
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    An ML Engineer designs, builds, and deploys models that help systems learn from data
                                    and make accurate, automated decisions.</div>
                            </div>
                        </div>
                    </div>
                    <div class="" style="animation-delay: 300ms;">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    Our engineers use TensorFlow, PyTorch, Scikit-learn, Keras, OpenCV, and cloud tools
                                    like AWS SageMaker and Google AI for model training and deployment.</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="lg:space-y-6 space-y-2">
                    <div class="" style="animation-delay: 0ms;">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                                class="accordion-trigger">
                                <h3 class="font-normal text-base md:font-medium md:text-base">Can I hire ML engineers
                                    for a short-term project?</h3>
                                <div
                                    class="flex-shrink-0 w-9 h-9 bg-card card-shadow dark:shadow-none flex items-center justify-center rounded-md">
                                    <div
                                        class="w-7 h-7 flex items-center justify-center bg-card card-shadow dark:shadow-none rounded-md ">
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    Yes, you can hire ML Engineers on a monthly, quarterly, or yearly plan, depending on
                                    your project’s duration and complexity.</div>
                            </div>
                        </div>
                    </div>
                    <div class="" style="animation-delay: 100ms;">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                                class="accordion-trigger">
                                <h3 class="font-normal text-base md:font-medium md:text-base">How can ML improve my
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    Machine Learning automates decisions, identifies patterns, predicts outcomes, and
                                    helps businesses save time and increase efficiency.</div>
                            </div>
                        </div>
                    </div>
                    <div class="" style="animation-delay: 200ms;">
                    ...
                    <div class="" style="animation-delay: 300ms;">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                                class="accordion-trigger">
                                <h3 class="font-normal text-base md:font-medium md:text-base"> What industries do your
                                    ML engineers specialize in?</h3>
                                <div
                                    class="flex-shrink-0 w-9 h-9 bg-card card-shadow dark:shadow-none flex items-center justify-center rounded-md">
                                    <div
                                        class="w-7 h-7 flex items-center justify-center bg-card card-shadow dark:shadow-none rounded-md ">
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    We’ve delivered ML solutions for fintech, healthcare, eCommerce, gaming,
                                    manufacturing, and SaaS industries.</div>
                            </div>
                        </div>
                    </div>
                </div>
