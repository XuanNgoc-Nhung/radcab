        <section class="relative w-full overflow-hidden bg-[#1E1E1E]">
            <div class="container w-full py-12 lg:py-16 sm:py-18 mx-auto lg:px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 items-center mt-5 px-4 lg:px-0">
                    <div class="flex flex-wrap lg:gap-2 sm:gap-1 sm:mb-2" id="region-tabs">
                        <h3
                            class="region-tab py-2 px-6 text-sm rounded-xl transition-colors duration-200 m-2 bg-blue-800 text-white cursor-pointer"
                            data-region="all">
                            All</h3>
                        <h3
                            class="region-tab py-2 px-6 text-sm  border border-gray-700 m-2 rounded-xl transition-colors duration-200 cursor-pointer text-white hover:bg-blue-800 hover:border-blue-800 hover:text-white"
                            data-region="India">
                            India</h3>
                        <h3
                            class="region-tab py-2 px-6 text-sm  border border-gray-700 m-2 rounded-xl transition-colors duration-200 cursor-pointer text-white hover:bg-blue-800 hover:border-blue-800 hover:text-white"
                ...
                <div class="relative mt-10 overflow-hidden">
                    <div class="flex lg:gap-1 sm:gap-2 md:gap-3" id="location-cards" style="transform: translate3d(0px, 0px, 0px);">
                        <div class="location-card flex-[0_0_100%] sm:flex-[0_0_50%] md:flex-[0_0_25%] xl:flex-[0_0_25%]" data-region="India"><a
                                class="block" href="https://maps.app.goo.gl/dtPoDCcof7iG8NB67">
                                <div
                                    class="group relative w-[300px] h-[300px] lg:w-[355px] lg:h-[400px] rounded-2xl overflow-hidden shadow-2xl cursor-pointer transition-all duration-300 mx-auto">
                                    ...
                                    <div
                                        class="absolute inset-0 bg-blue-600 transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100">
                        ...
                        <div class="location-card flex-[0_0_100%] sm:flex-[0_0_50%] md:flex-[0_0_25%] xl:flex-[0_0_25%]" data-region="USA"><a
                        ...
                        <div class="location-card flex-[0_0_100%] sm:flex-[0_0_50%] md:flex-[0_0_25%] xl:flex-[0_0_25%]" data-region="Australia"><a
                        ...
                        <div class="location-card flex-[0_0_100%] sm:flex-[0_0_50%] md:flex-[0_0_25%] xl:flex-[0_0_25%]" data-region="Canada"><a
                                class="block" href="#">
                                <div
                                    class="group relative w-[300px] h-[300px] lg:w-[355px] lg:h-[400px] rounded-2xl overflow-hidden shadow-2xl cursor-pointer transition-all duration-300 mx-auto">
                        ...
                        <div class="location-card flex-[0_0_100%] sm:flex-[0_0_50%] md:flex-[0_0_25%] xl:flex-[0_0_25%]" data-region="UK"><a
                        ...
                        <div class="location-card flex-[0_0_100%] sm:flex-[0_0_50%] md:flex-[0_0_25%] xl:flex-[0_0_25%]" data-region="UAE"><a
                                class="block" href="#">
                                <div
                                    class="group relative w-[300px] h-[300px] lg:w-[355px] lg:h-[400px] rounded-2xl overflow-hidden shadow-2xl cursor-pointer transition-all duration-300 mx-auto">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                tabs.forEach(tab => {
                    tab.addEventListener('click', function() {
                        ...
                        tabs.forEach(t => {
                            if (t === this) {
                                t.classList.remove('border', 'border-gray-700');
                                t.classList.add('bg-blue-800', 'text-white');
                            } else {
                                t.classList.remove('bg-blue-800');
                                t.classList.add('border', 'border-gray-700');
                            }
                        });
