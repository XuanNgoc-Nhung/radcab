    <section class="bg-[#0B0B0D] text-white py-16 px-6 md:px-12">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div class="md:w-1/2 w-full grid grid-cols-2 sm:grid-cols-2 md:grid-cols-1 gap-4 wow animate__animated animate__fadeInRight"><a target="_blank"
                    rel="noopener noreferrer"
                    class="bg-[#1A1A1C] flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl shadow-lg hover:bg-[#222225] transition-all duration-300 wow animate__animated animate__fadeInUp" data-wow-delay="0.1s"
                    ...
                    class="bg-[#1A1A1C] flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl shadow-lg hover:bg-[#222225] transition-all duration-300 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s"
                    ...
                    class="bg-[#1A1A1C] flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl shadow-lg hover:bg-[#222225] transition-all duration-300 wow animate__animated animate__fadeInUp" data-wow-delay="0.3s"
                    ...
                    class="bg-[#1A1A1C] flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl shadow-lg hover:bg-[#222225] transition-all duration-300 wow animate__animated animate__fadeInUp" data-wow-delay="0.4s"
