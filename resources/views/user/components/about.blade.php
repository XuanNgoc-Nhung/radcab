<section
    class="relative flex flex-col items-center justify-center min-h-[auto] sm:min-h-screen md:min-h-screen text-center px-4 py-16 sm:px-6 md:px-6 overflow-hidden transition-colors duration-700 bg-transparent">
    <div class="absolute inset-0 w-full h-full z-[0]"><img alt="Background" decoding="async" data-nimg="fill"
            class="object-cover transition-opacity duration-700"
...
<section class="pt-12 sm:py-16">
            ...
            <div
                ...
                <ul class="space-y-3 mb-8">
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>Our people love what they do and it shows in every project.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We believe in teamwork, collaboration, and mutual respect.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We retain over 95% of our talent because we value their growth.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We celebrate creativity and encourage innovation every day.</span>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We take complete ownership of our work from start to finish.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>Every team member is accountable for delivering excellence.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We act with integrity, even when no one is watching.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>Our commitment ensures timely and quality project delivery.</span>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>Every project we build focuses on cost efficiency, transparency, and
                            scalability.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>Our goal is to maximize client ROI through smart architecture and
                            automation.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We measure success by performance, adoption, and profitability.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 bg-card dark:bg-blue-500 dark:shadow-none card-shadow rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We align blockchain innovation with clear financial and strategic
                            outcomes.</span>
                    </li>
                </ul>
            </div>
                    ...
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>Our team continuously innovates to push the boundaries of blockchain
                            technology.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We ensure 24/7 monitoring, maintenance, and optimization of networks and
                            protocols.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>Every solution is crafted with precision, speed, and security in
                            mind.</span>
                    </li>
                    <li class="flex items-start gap-2 text-base fw-normal">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-check" aria-hidden="true">
                                <path d="M20 6 9 17l-5-5"></path>
                            </svg></div><span>We persistently refine processes to deliver maximum value to our
                            clients.</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 max-w-7xl mx-auto">
                <div
                    ...
                    <div
                        ...
                        <div
                            class=" w-10 h-10 sm:w-12 sm:h-12 rounded  flex items-center justify-center button-shadow bg-gradient-to-b from-primary to-primary/60  dark:from-primary/30 dark:to-primary/10 ">
                            <svg stroke="currentColor" fill="none" stroke-width="1.5" viewBox="0 0 24 24"
                                aria-hidden="true" class="text-white text-2xl" height="1em" width="1em"
                        ...
                        <p class="text-sm sm:text-base text-muted-foreground">To make web3 accessible to everyone,
                            everywhere</p>
                    </div>
                </div>
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                class="text-white text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                <path fill="none" stroke-width="2"
                                    d="M1,16 L8,9 L13,14 L23,4 M0,22 L23.999,22 M16,4 L23,4 L23,11"></path>
                            </svg></div>
                        <h3 class="font-medium text-lg sm:text-sm md:text-2xl">Process Optimization</h3>
                        <p class="text-sm sm:text-base text-muted-foreground">To offer an automated and frictionless
                            experience</p>
                    </div>
                </div>
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512"
                                ...
                                <path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"
                                    d="M294 240s-21.51 16-38 16-38-16-38-16"></path>
                            </svg></div>
                        <h3 class="font-medium text-lg sm:text-sm md:text-2xl">Smart Decisions</h3>
                        <p class="text-sm sm:text-base text-muted-foreground">To be as transparent and verifiable as we
                            can</p>
                    </div>
                </div>
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-combine text-white text-2xl"
                                aria-hidden="true">
                        ...
                        <h3 class="font-medium text-lg sm:text-sm md:text-2xl">Complaint</h3>
                        <p class="text-sm sm:text-base text-muted-foreground">To engage regulators and comply with
                            existing rules</p>
                    </div>
                </div>
            </div>
    ...
    <div class="lg:pb-16 pb-8 lg:mt-16 mt-4 lg:mb-12 mb-4 bg-black text-white ">
        <div class="px-4 md:px-4">
            <div class="flex items-center justify-center lg:py-10 lg:p-4 p-0 text-white">
                <style>
                    @keyframes fadeInUp {
                        from {
                            opacity: 0;
                    ...
                    <div class="mt-8 lg:p-8 p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center" id="timeline-content">
                            ...
                            <div id="timeline-description"
                                ...
                                was still warming up to decentralized technologies.</div>
                        </div>
                    </div>
    ...
    <div class="lg:pt-16 relative">
        <div class="relative overflow-hidden" style="background-color:#242424">
            ...
            <div class="hidden md:block absolute right-0 bottom-0 w-[40%] h-full"><img alt="Office Banner"
                    loading="lazy" decoding="async" data-nimg="fill" class="object-cover object-bottom-right"
                    style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent"
                    sizes="100vw"
                    srcset="/nadcab-office.png?w=640&amp;q=75 640w, /nadcab-office.png?w=750&amp;q=75 750w, /nadcab-office.png?w=828&amp;q=75 828w, /nadcab-office.png?w=1080&amp;q=75 1080w, /nadcab-office.png?w=1200&amp;q=75 1200w, /nadcab-office.png?w=1920&amp;q=75 1920w, /nadcab-office.png?w=2048&amp;q=75 2048w, /nadcab-office.png?w=3840&amp;q=75 3840w"
                    src="/nadcab-office.png?w=3840&amp;q=75"></div>
        </div>
    </div>
                    ...
                    <div class="wow animate__animated animate__fadeInUp animate__delay-1s"
                        ...
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    We cater to a wide range of industries, including fintech, real estate, healthcare,
                                    supply chain, education, and entertainment — helping them integrate blockchain for
                                    efficiency and transparency.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wow animate__animated animate__fadeInUp" style="animation-delay:0ms">
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    Yes, we handle the full development cycle — from concept design and smart contract
                                    creation to deployment, testing, and post-launch maintenance.</div>
                            </div>
                        </div>
                    </div>
                    <div class="wow animate__animated animate__fadeInUp animate__delay-1s"
                        ...
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    Our team is skilled in Ethereum, Binance Smart Chain, Polygon, Solana, and
                                    Hyperledger, along with popular frameworks like React, Next.js, and Node.js for
                                    blockchain integration.</div>
                            </div>
                        </div>
                    </div>
                    <div class="wow animate__animated animate__fadeInUp animate__delay-2s"
                        ...
                        <div class="accordion-item bg-card rounded-lg card-shadow overflow-hidden"><button
                            ...
                            <div class="accordion-content px-6 overflow-hidden transition-all duration-300 max-h-0">
                                <div
                                    class="text-muted-foreground  [&amp;_a]:text-blue-600 [&amp;_ul]:list-disc  [&amp;_ul]:ml-5  [&amp;_ol]:list-decimal  [&amp;_ol]:ml-5 [&amp;_a:hover]:underline ">
                                    Absolutely. We actively develop Web3 and metaverse-ready platforms, integrating
                                    blockchain, NFTs, and immersive experiences to help brands enter the decentralized
                                    world.</div>
                            </div>
                        </div>
                    </div>
