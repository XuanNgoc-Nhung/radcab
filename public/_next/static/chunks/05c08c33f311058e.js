(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 8341, (e, t, n) => {
    ...
    let r = e.r(55682),
        ...
        p = e => {
            ...
            l ? (_.innerHTML = l.__html || "", b()) : o ? (_.textContent = "string" == typeof o ? o : Array.isArray(o) ? o.join("") : "", b()) : t && (_.src = t, d.set(t, g)), (0, c.setAttributesFromProps)(_, e), "worker" === u && _.setAttribute("type", "text/partytown"), _.setAttribute("data-nscript", u), p && (e => {
    ...
    function _(e) {
        ...
        if ((0, o.useEffect)(() => {
                if (!I.current) {
                    ...
                    else "lazyOnload" === c && ("complete" === document.readyState ? (0, s.requestIdleCallback)(() => p(e)) : window.addEventListener("load", () => {
                        (0, s.requestIdleCallback)(() => p(e))
                    }));
                    I.current = !0
                }
            }, [e, c]), ("beforeInteractive" === c || "worker" === c) && (_ ? (g[c] = (g[c] || []).concat([{
                id: t,
                src: n,
                onLoad: r,
                onReady: i,
            ...
            if (y && y.forEach(e => {
                ...
                if (!n) return b.dangerouslySetInnerHTML && (b.children = b.dangerouslySetInnerHTML.__html, delete b.dangerouslySetInnerHTML), (0, l.jsx)("script", {
                    nonce: O,
                ...
                else return a.default.preload(n, b.integrity ? {
                    as: "script",
            ...
            "afterInteractive" === c && n && a.default.preload(n, b.integrity ? {
                as: "script",
                integrity: b.integrity,
                nonce: O,
                crossOrigin: b.crossOrigin
