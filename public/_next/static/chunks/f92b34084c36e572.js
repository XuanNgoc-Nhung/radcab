(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 91915, (e, r, t) => {
                ...
                function l(e) {
                    let {
                        ...
                        unauthorized: n,
                        children: i
                    } = e, l = (0, c.useUntrackedPathname)(), d = (0, o.useContext)(u.MissingSlotContext);
                ...
                function j(e) {
                    let {
                        ...
                        cacheNode: n,
                        url: a
                    } = e, u = (0, i.useContext)(s.GlobalLayoutRouterContext);
                    ...
                    let {
                        tree: f
                    } = u, h = null !== n.prefetchRsc ? n.prefetchRsc : n.rsc, y = (0, i.useDeferredValue)(n.rsc, h), g = "object" == typeof y && null !== y && "function" == typeof y.then ? (0, i.use)(y) : y;
                    if (!g) {
                        let e = n.lazyData;
                        if (null === e) {
                ...
                function T(e) {
                    ...
                    } = e, P = (0, i.useContext)(s.LayoutRouterContext);
                    ...
                    let {
                        ...
                        parentSegmentPath: v,
                        url: S
                    } = P, T = E.parallelRoutes, C = T.get(r);
                ...
                function o(e, r) {
                    throw Object.defineProperty(new n.StaticGenBailoutError(`Route ${e} couldn't be rendered statically because it used ${r}. See more info here: https://nextjs.org/docs/app/building-your-application/rendering/static-and-dynamic#dynamic-rendering`), "__NEXT_ERROR_CODE", {
                        value: "E576",
                        enumerable: !1,
                        configurable: !0
                    })
                ...
                function c(e, r) {
                    throw Object.defineProperty(new n.StaticGenBailoutError(`Route ${e} with \`dynamic = "error"\` couldn't be rendered statically because it used ${r}. See more info here: https://nextjs.org/docs/app/building-your-application/rendering/static-and-dynamic#dynamic-rendering`), "__NEXT_ERROR_CODE", {
                        value: "E543",
                        enumerable: !1,
                        configurable: !0
                    })
                            ...
                            let u = (0, i.makeHangingPromise)(o.renderSignal, t.route, "`searchParams`"),
                                d = new Proxy(u, {
                                    get(e, r, t) {
                                        ...
                                        switch (r) {
                                            case "then":
                                                return (0, a.annotateDynamicAccess)("`await searchParams`, `searchParams.then`, or similar", o), n.ReflectAdapter.get(e, r, t);
                                            case "status":
                                                return (0, a.annotateDynamicAccess)("`use(searchParams)`, `searchParams.status`, or similar", o), n.ReflectAdapter.get(e, r, t);
                                            default:
                                ...
                                g = new Proxy(y, {
                                    get(e, r, t) {
                                        ...
                                        switch (r) {
                                            case "then":
                                                {
                                                    let e = "`await searchParams`, `searchParams.then`, or similar";f.dynamicShouldError ? (0, l.throwWithStaticGenerationBailoutErrorWithDynamicError)(f.route, e) : "prerender-ppr" === p.type ? (0, a.postponeWithTracking)(f.route, e, p.dynamicTracking) : (0, a.throwToInterruptStaticGeneration)(e, f, p);
                                                    return
                                                }
                                            case "status":
                                                {
                                                    let e = "`use(searchParams)`, `searchParams.status`, or similar";f.dynamicShouldError ? (0, l.throwWithStaticGenerationBailoutErrorWithDynamicError)(f.route, e) : "prerender-ppr" === p.type ? (0, a.postponeWithTracking)(f.route, e, p.dynamicTracking) : (0, a.throwToInterruptStaticGeneration)(e, f, p);
                                                    return
                                                }
                                            default:
                                                if ("string" == typeof r && !s.wellKnownProperties.has(r)) {
                                                    let e = (0, s.describeStringPropertyAccess)("searchParams", r);
                                                    f.dynamicShouldError ? (0, l.throwWithStaticGenerationBailoutErrorWithDynamicError)(f.route, e) : "prerender-ppr" === p.type ? (0, a.postponeWithTracking)(f.route, e, p.dynamicTracking) : (0, a.throwToInterruptStaticGeneration)(e, f, p)
                                                }
                                                return n.ReflectAdapter.get(e, r, t)
                                        }
                                    },
                                    has(e, r) {
                                        if ("string" == typeof r) {
                                            let e = (0, s.describeHasCheckingStringProperty)("searchParams", r);
                                            return f.dynamicShouldError ? (0, l.throwWithStaticGenerationBailoutErrorWithDynamicError)(f.route, e) : "prerender-ppr" === p.type ? (0, a.postponeWithTracking)(f.route, e, p.dynamicTracking) : (0, a.throwToInterruptStaticGeneration)(e, f, p), !1
                                        }
                    ...
                    let t = Promise.resolve({}),
                        a = new Proxy(t, {
                            get: function r(a, o, c) {
                                return Object.hasOwn(t, o) || "string" != typeof o || "then" !== o && s.wellKnownProperties.has(o) || (0, l.throwForSearchParamsAccessInUseCache)(e, r), n.ReflectAdapter.get(a, o, c)
                            },
                            has: function r(t, a) {
                                return "string" != typeof a || "then" !== a && s.wellKnownProperties.has(a) || (0, l.throwForSearchParamsAccessInUseCache)(e, r), n.ReflectAdapter.has(t, a)
                            },
                            ownKeys: function r() {
                ...
                function _(e) {
                    ...
                    if (r) return r;
                    let t = Promise.resolve(e);
                    return m.set(e, t), Object.keys(e).forEach(r => {
                        s.wellKnownProperties.has(r) || Object.defineProperty(t, r, {
                            get() {
                                let t = o.workUnitAsyncStorage.getStore();
                    ...
                    return Object.defineProperty(Error(`${t}used ${r}. \`searchParams\` should be awaited before using its properties. Learn more: https://nextjs.org/docs/messages/sync-dynamic-apis`), "__NEXT_ERROR_CODE", {
                        value: "E249",
                        enumerable: !1,
                        configurable: !0
                    })
                        ...
                        return Object.defineProperty(Error(`${n}used ${r}. \`searchParams\` should be awaited before using its properties. The following properties were not available through enumeration because they conflict with builtin or well-known property names: ${function(e){switch(e.length){case 0:throw Object.defineProperty(new c.InvariantError("Expected describeListOfPropertyNames to be called with a non-empty list of strings."),"__NEXT_ERROR_CODE",{value:"E531",enumerable:!1,configurable:!0});case 1:return`\
                                `${e[0]}\``;
                                case 2:
                                    return `\`${e[0]}\` and \`${e[1]}\``;
                                default:
